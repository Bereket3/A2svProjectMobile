...
class _DetailState extends State<Detail> {
  ...
  @override
  void initState() {
    BlocProvider.of<ProductBloc>(context).add(LoadSingleProductEvent(id: product.id));
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return PopScope(
      onPopInvokedWithResult: (didTouch, val) {
        if (didTouch) {
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                TextButton(
                                  onPressed: () => {
                                    BlocProvider.of<ProductBloc>(context).add(DeleteProductEvent(id: product.id)),
                                    BlocProvider.of<ProductBloc>(context).add(LoadAllProductEvent()),
                                    Navigator.pop(context),
                                ...
                                TextButton(
                                  onPressed: () async {
                                    await Navigator.pushNamed(context, '/update', arguments: state.product);
                                  },
                                  style: TextButton.styleFrom(
                                      elevation: 2,
