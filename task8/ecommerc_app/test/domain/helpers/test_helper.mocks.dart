...
import 'package:ecommerc_app/core/error/failure.dart' as _i5;
import 'package:ecommerc_app/features/product/domain/entities/product.dart' as _i6;
...
class MockProductRepository extends _i1.Mock implements _i3.ProductRepository {
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, _i6.ProductEntity>> getCurrentProduct(
          int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #getCurrentProduct,
  ...
  @override
  _i4.Future<_i2.Either<_i5.Failure, bool>> deleteProduct(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #deleteProduct,
          [id],
